...
The page must include a responsive gallery, category filtering, and a lightbox for high-resolution images.

# Functional Requirements  
1. Image List: Display 12 images in a responsive grid (3–6 columns)  
2. Category Filter: Buttons to filter by "Nature", "Portrait", "Architecture", "All"  
3. Lightbox Modal: Clicking an image opens an overlay with zoom and navigation arrows  
4. Responsive Design: Desktop, tablet, mobile (Android/iOS)  
5. W3C Compliance: Semantic HTML5 and modern CSS3  
